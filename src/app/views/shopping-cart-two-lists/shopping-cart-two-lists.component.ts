...
@Component({
  selector: 'app-shopping-cart-two-lists',
  imports: [FormsModule, ReactiveFormsModule, CommonModule,ItemComponent],
  templateUrl: './shopping-cart-two-lists.component.html',
  styleUrl: './shopping-cart-two-lists.component.css'
})
export class ShoppingCartTwoListsComponent {
    ...
    constructor(private fb : FormBuilder) {
      ...
      filterItemsByPrice = computed(()=>{
        return this.items().filter(i=>i.price <= this.price());
      })
